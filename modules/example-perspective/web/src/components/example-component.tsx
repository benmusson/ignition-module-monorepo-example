import {
    ...
    ComponentMeta,
    ComponentProps, ComponentStoreDelegate, JsObject, PComponent, PropertyTree,
    SizeObject, StyleObject
...
export function ExampleComponent(props: ComponentProps<ExampleComponentProps>) {
    return <div {...props.emit() }>
        {props.props.text}
    </div>
}

class ExampleComponentDelegate extends ComponentStoreDelegate {
